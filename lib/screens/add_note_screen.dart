    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            bool checkIfTitleContainsValueAndDescriptionDoesNot =
                title.isNotEmpty && description.isEmpty;
            bool checkIfDescriptionContainsValueAndTitleDoesNot =
                description.isNotEmpty && title.isEmpty;
            bool checkIfBothTitleAndDescriptionContainsValue =
